...
Welcome! This guide explains how to contribute to abacus-skill.
...
```bash
git clone https://github.com/<YOUR_USERNAME>/abacus-skill-skill.git
cd abacus-skill-skill
```
...
git clone https://github.com/SciX-Skill/abacus-skill-skill.git
cd abacus-skill-skill
...
https://github.com/SciX-Skill/abacus-skill-skill/issues
